...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    <div class="card card-outline card-primary">
      ...
      <form action="<?= base_url('/resetPassword/' . $user_id) ?>" method="post">
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Digite sua nova senha" name="senha" required>
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Repita sua senha" name="senha" required>
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
